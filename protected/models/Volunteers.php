...
class Volunteers extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userid, locationid', 'numerical', 'integerOnly'=>true),
			array('homeoroffice', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, userid, locationid, homeoroffice', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('homeoroffice',$this->homeoroffice,true);
